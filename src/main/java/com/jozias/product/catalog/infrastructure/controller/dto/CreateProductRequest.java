...
@Schema(description = "Requisição para criação de um novo produto")
public record CreateProductRequest(
                ...
                @Schema(description = "ID do vendedor proprietário do produto", example = "1") @NotNull(message = "Seller ID is required") Long sellerId,

                @Schema(description = "Lista de variantes do produto (cor, tamanho, etc.)") @Valid List<CreateProductVariantRequest> variants) {
}
